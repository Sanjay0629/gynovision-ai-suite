              ...
              {navLinks.map((link) =>
                link.type === "scroll" ? (
                  <button
                    ...
                    className="px-4 py-2.5 rounded-lg text-sm font-medium transition-all text-muted-foreground hover:text-foreground hover:bg-muted/50 hover:scale-105 active:scale-95 text-left"
                  >
                    {link.label}
                  </button>
                ) : (
